...
graph TB
    subgraph "缓存层体系"
        A[CacheLayerMixin ABC]
        B[DynamicLayer]
        C[DynamicSlidingWindowLayer]
        D[QuantizedLayer]
        E[QuantoQuantizedLayer]
        F[HQQQuantizedLayer]
        G[StaticLayer]
        H[StaticSlidingWindowLayer]
        I[LinearAttentionCacheLayerMixin ABC]
        J[LinearAttentionLayer]
    end
    ...
    subgraph "缓存容器体系"
        ...
        M[StaticCache]
        N[QuantizedCache]
        O[EncoderDecoderCache]
    end
    
    subgraph "注册表"
        P[LAYER_TYPE_CACHE_MAPPING]
    end
